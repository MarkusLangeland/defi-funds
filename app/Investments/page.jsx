    ...
    datasets: [
      {
        ...
        // label: 'Dataset 2',
        data: [
          5000, 6000, 4000, 5000, 3500, 5500, 7000, 5000, 6000, 4000, 5000,
          3500, 5500, 7000, 5000, 6000, 4000, 5000, 3500, 5500, 7000,
        ],
    ...
    return (
      <div className="w-11/12 border border-gray-200 rounded-md flex items-center justify-between p-4">
        <input
          ...
          placeholder="22"
          pattern="^[0-9,.-]*$"
          className="xs:w-1/2 w-1/3"
        />
        <div>
          <div className="dropdown">
            <button
              className="flex items-center justify-center h-fit gap-2 bg-gray-100 rounded-3xl pr-3 pl-3 pt-1 pb-1 text-sm"
              onClick={() => setChoseCurrencyOpen(!choseCurrencyOpen)}
            >
              <FaChevronDown /> <SiBitcoinsv className=" text-orange-400" /> BTC
            </button>
            <div
              className={
                choseCurrencyOpen
    ...
    return (
      <div className="w-11/12 border border-gray-200 rounded-md flex items-center justify-between p-4 pt-5 pb-5">
        ...
        <div className="dropdown">
          <button
            className="flex items-center justify-center h-fit gap-2 bg-gray-100 rounded-3xl pr-3 pl-3 pt-1 pb-1 text-sm "
            onClick={() => setChoseTokenOpen(!choseTokenOpen)}
          >
            <FaChevronDown /> Select Token
          </button>
          <div
            className={
              choseTokenOpen
    ...
    <div className="w-screen pt-20 flex justify-center items-center pb-10">
      <div className=" 3xl:w-2000 w-full">
        <div className=" flex xl:flex-row flex-col items-center justify-evenly">
          <div className="xl:w-3/5 w-10/12">
            <div className="flex items-center justify-between mb-5">
              <div className="flex justify-center flex-col">
                <h2 className=" text-sm text-gray-400">Portfolio Balance</h2>
              ...
              <div className="w-fit border border-gray-200 flex items-center justify-around rounded-md h-fit gap-1 p-1">
                <button
                  onClick={() => handleClickTimeFrame("1W")}
                  className={
                    week
                      ? "shadow-md border border-gray-100 rounded-sm p-1 text-xs"
                      : "text-xs"
                  }
                >
                  1W
                ...
                <button
                  onClick={() => handleClickTimeFrame("1M")}
                  className={
                    month
                      ? "shadow-md border border-gray-100 rounded-sm p-1 text-xs"
                      : "text-xs"
                ...
                <button
                  onClick={() => handleClickTimeFrame("3M")}
                  className={
                    threeMonths
                      ? "shadow-md border border-gray-100 rounded-sm p-1 text-xs"
                      : " text-xs"
                ...
                <button
                  onClick={() => handleClickTimeFrame("1Y")}
                  className={
                    year
                      ? "shadow-md border border-gray-100 rounded-sm p-1 text-xs"
                      : " text-xs"
                ...
                <button
                  onClick={() => handleClickTimeFrame("3Y")}
                  className={
                    threeYears
                      ? "shadow-md border border-gray-100 rounded-sm p-1 text-xs"
                      : " text-xs"
          ...
          <div className="w-10/12 xl:w-1/4 rounded-xl ">
            ...
            <div className="flex flex-col justify-center items-center">
              ...
              <button
                className="border border-gray-200 p-2 m-1 rounded-md shadow-md"
                onClick={() => setTokenToCurrency(!tokenToCurrency)}
              >
                {" "}
                <AiOutlineArrowDown />{" "}
              </button>
          ...
          <div className="w-11/12">
            ...
            <div>
              <div className=" flex justify-center items-center mt-8">
                ...
                <p className="sm:w-2/12 w-3/12 text-gray-400 text-sm">Funds</p>
                <p className="w-2/12 text-gray-400 text-sm">Shares</p>
              ...
              <div className=" flex  justify-center items-center mt-8">
                ...
                <p className="flex sm:w-2/12 w-4/12 font-semibold justify-start items-center gap-2">
                  <Image
              ...
              <div className=" flex  justify-center items-center mt-8">
                ...
                <p className="w-2/12 font-semibold">100</p>
                <p className="w-2/12 font-semibold">$ 200</p>
                <div className="sm:w-3/12 2/12 flex items-center gap-2">
                  <div className=" z-0 w-full md:flex hidden rounded-xl bg-blue-100 h-fit">
                    <div className=" z-10 w-4/12 bg-primary text-white pl-2 rounded-xl h-2"></div>
                  </div>
              ...
              <div className=" flex  justify-center items-center mt-8">
                ...
                <p className="w-2/12 font-semibold">100</p>
                <p className="w-2/12 font-semibold">$ 300</p>
                <div className="sm:w-3/12 2/12 flex items-center gap-2">
                  <div className=" z-0 w-full md:flex hidden rounded-xl bg-blue-100 h-fit">
                    <div className=" z-10 w-4/12 bg-primary text-white pl-2 rounded-xl h-2"></div>
                  </div>
              ...
              <div className=" flex  justify-center items-center mt-8">
                ...
                <p className="w-2/12 font-semibold">100</p>
                <p className="w-2/12 font-semibold">$ 150</p>
                <div className="sm:w-3/12 2/12 flex items-center gap-2">
                  <div className=" z-0 w-full md:flex hidden rounded-xl bg-blue-100 h-fit">
                    <div className=" z-10 w-4/12 bg-primary text-white pl-2 rounded-xl h-2"></div>
                  </div>
