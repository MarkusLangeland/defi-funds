       ...
       <div className='w-11/12 h-fit mt-28 new-fund bg-gray-100 rounded-xl shadow-lg mb-20 overflow-x-hidden'>
        ...
        <div className=''>
            <div className='flex align-middle justify-between sm:flex-row flex-col mb-10 mt-10 ml-6 mr-6 gap-5'>
              ...
              Fund Name
              <input type="text" onChange={e => setFundName(e.target.value)} placeholder='Name of your fund'/>
              </label>
              ...
              <label className='flex flex-col sm:w-1/4 w-full'>
                ...
                <input type="text" onChange={e => setInitialSupply(e.target.value)} placeholder='Enter Value' pattern="^[0-9,.-]*$"/>
              </label>
            ...
            <input type="text" onChange={e => setDepositFee(e.target.value)} placeholder='Enter Value' pattern="^[0-9,.-]*$"/>
            </label>

            </div>
            <label className='flex flex-col ml-6 mr-6'>
              Fund Strategy
              <input type="text" onChange={e => setDescription(e.target.value)} placeholder="Enter your fund strategy"/>
            </label>
            ...
            <label className='flex flex-col sm:w-1/2 w-full'>
              ...
              <input type="text" onChange={e => setImagelink(e.target.value)} placeholder='Logo for the fund'/>
            </label>
            <label className='flex flex-col sm:w-1/2 w-full'>
              Website
              <input type="text" onChange={e => setWebsitelink(e.target.value)} placeholder='Add Link to Website'/>
            </label>
            </div>
            <div className='flex align-middle justify-center'>
            <button onClick={() => handleSubmitNewFund()} className='bg-primary h-20 rounded-lg text-lg text-white w-11/12 mb-10' >
              Create Fund
            </button>
            </div>
          </div>
