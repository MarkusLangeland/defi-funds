        ...
        <div className=" flex xl:flex-row flex-col items-center justify-evenly">
          <div className="xl:w-3/5 w-10/12">
            ...
            <div className="flex justify-evenly items-center mb-10">
              ...
              <div className="text-center">
                <h3 className="text-gray text-sm">Deposit fee</h3>
            ...
            <div className="flex items-center justify-center w-full">
              <div className=" w-5/6">
                <div className=" flex justify-between items-center mt-8">
                  <p className="w-1/12 text-gray-400 text-sm">Assets</p>
                  <p className="sm:w-3/12 2/12 text-gray-400 text-sm">
                    {" "}
                    Percentage %
                  </p>
                </div>
                ...
                <div className="flex gap-2 mt-10 items-center">
                  <h4 className=" font-bold">Fund Strategy:</h4>
                  <p className=" text-gray-400 text-sm">This is a sale Pool</p>
                </div>
              </div>
            </div>
          </div>
