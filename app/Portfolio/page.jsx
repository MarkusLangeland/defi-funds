        ...
        <div className='w-11/12'>
          ...
          <div className=' w-5/6'>
            <div className=' flex justify-between items-center mt-8'>
              ...
              <p className='sm:w-3/12 2/12 text-gray-400 text-sm'> Percentage %</p>
            </div>
             {/* .... Map..... */}
             <div className=' flex  justify-between items-center mt-8'>
              <p className='flex sm:w-2/12 w-4/12 font-semibold justify-start items-center gap-2'><Image src='/LogoDefiFunds.png' alt='Logo' width="400" height = "400" className='h-7 w-7'/> Bitcoin</p>
            ...
            <div className='flex gap-2 mt-10 items-center'>
              <h4 className=' font-bold'>Fund Strategy:</h4><p className=' text-gray-400 text-sm'>This is a sale Pool</p>
            </div>
